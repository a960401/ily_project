...
class BarsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bar" do
    assert_difference('Bar.count') do
      post bars_url, params: { bar: { content: @bar.content, description: @bar.description, latitude: @bar.latitude, longitude: @bar.longitude, picture: @bar.picture, title: @bar.title } }
    end
  ...
  test "should update bar" do
    patch bar_url(@bar), params: { bar: { content: @bar.content, description: @bar.description, latitude: @bar.latitude, longitude: @bar.longitude, picture: @bar.picture, title: @bar.title } }
