...
class SnacksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create snack" do
    assert_difference('Snack.count') do
      post snacks_url, params: { snack: { description: @snack.description, latitude: @snack.latitude, longitude: @snack.longitude, picture: @snack.picture, section: @snack.section, title: @snack.title } }
    end
  ...
  test "should update snack" do
    patch snack_url(@snack), params: { snack: { description: @snack.description, latitude: @snack.latitude, longitude: @snack.longitude, picture: @snack.picture, section: @snack.section, title: @snack.title } }
